...
function ClickCard({
  id,
  href = `/__todo/${id.toLowerCase()}`, // placeholder route
  children,
}: {
  id: string;
  href?: string;
...
export default function HomePage() {
  return (
    <main className="mx-auto max-w-5xl px-4 py-10 relative">
      <DevLabel id="P1" position="top-left" />

      {/* C1: Welcome (Settings + Sign Out) */}
      <section className="relative mt-2 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <CardId id="C1" />
