                    ...
                    <div className="grid grid-cols-2 gap-4">
                          ...
                          {formData.option1Cost === "N/A" ? (
                            ...
                            <>
                              <input
                                ...
                                className="flex-1 p-2 border rounded-md border-red-300"
                              />
                              <button
                                type="button"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          placeholder="0"
                          className={`w-full mt-1 p-2 border rounded-md ${formData.option1Cost === "N/A" ? 'bg-gray-100 text-gray-600 border-gray-300' : 'border-red-300'}`}
