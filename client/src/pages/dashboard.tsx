...
export default function Dashboard() {
  ...
  // Helper functions for dual-grade detection (memoized to prevent screen flashing)
  const hasDualDefects = useCallback((defectsText: string): { hasService: boolean, hasStructural: boolean, serviceGrade: number, structuralGrade: number } => {
  ...
  // Function to get grade color based on MSCC5 standards (memoized)
  const getGradeColor = useCallback((grade: number, defectType: 'service' | 'structural') => {
