...
export default function PR2ConfigClean() {
  ...
  const getTemplateType = (categoryId: string): 'P26' | 'P006' | 'P006a' | 'MMP1' | 'MMP2' => {
    ...
    } else if (categoryId === 'test-card' || categoryId === 'cctv-jet-vac' || categoryId === 'cctv-van-pack' || categoryId === 'patching' || categoryId === 'van-pack' || categoryId === 'jet-vac' || categoryId === 'cctv-cleansing-root-cutting' || categoryId === 'cctv') {
      return 'MMP1'; // Test Card, CCTV/Jet Vac, CCTV/Van Pack, Patching, Van Pack, Jet Vac, CCTV/Cleansing/Root Cutting, and CCTV use MMP1 template with 5 placeholder UI cards
