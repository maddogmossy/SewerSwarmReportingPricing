  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* P19 DB15: TP1 CCTV Vehicle Travel Rates - Only show on main cctv-jet-vac page, NOT when editing individual IDs */}
        ...
        {/* P26 DB15: TP2 Patching Vehicle Travel Rates - Only show on main patching page, NOT when editing individual IDs */}
        ...
        {/* P4 DB15: TP3 Robotic Cutting Vehicle Travel Rates - Only show on main robotic-cutting page, NOT when editing individual IDs */}
        ...
        {categoryId !== 'patching' && getPipeSizeConfigurations().length > 0 && 
          ...
          <Collapsible key={pipeSizeConfig.id} defaultOpen={pipeSizeConfig.id === parseInt(editId || '0')}>
            ...
            {/* TP2 categories now use P26 hierarchical structure - no individual dropdowns */}
            {getTemplateType(categoryId) === 'TP2' ? (
              <div className="space-y-4 p-4 border rounded-lg bg-gray-100">
                <h3 className="text-lg font-semibold text-gray-600 mb-4">TP2 - Redirected to P26 System</h3>
                <div className="text-sm text-gray-600 bg-blue-50 p-3 rounded border">
                  TP2 patching configurations now use the unified P26 hierarchical structure.
                  Please use the main patching category interface above for all TP2 configurations.
                </div>
              </div>
            ) : (
