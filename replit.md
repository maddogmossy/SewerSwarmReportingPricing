...
- June 28, 2025. Fixed equipment API request format issue: Corrected malformed API requests causing "invalid HTTP method" errors by standardizing apiRequest call format to apiRequest('METHOD', '/endpoint', data) across all equipment update/delete/create operations in cleansing-pricing.tsx and jetting-pricing.tsx, resolving unhandled promise rejections and enabling proper equipment management functionality.
```
