...
- June 28, 2025. Enhanced utilities sector exclusivity validation: Implemented utilities-ONLY pricing requirement filtering out mixed-sector entries like ["utilities","highways","construction"] to ensure utilities reports only use pure utilities sector pricing (sectors.length === 1 && sectors[0] === 'utilities'), eliminating cross-contamination from multi-sector equipment configurations and enforcing strict sector isolation for accurate cost calculations.
