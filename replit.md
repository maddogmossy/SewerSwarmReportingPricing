...
- A1-16 Grid Auto-Selection Fix: Corrected utilities sector auto-selection logic from legacy 'id7' format to proper 'utilities' sector name matching. System now properly highlights utilities card when autoSelectUtilities=true parameter is passed from dashboard navigation.
