...
- June 28, 2025. Added pricing button to dashboard navigation: Users can now easily access pricing settings directly from the dashboard page via a dedicated "Pricing" button with Settings icon positioned next to the Upload Report button for improved user experience and quick access to equipment cost configuration.
```
