...
© 2025 Professional Sewer Condition Assessment Services`;
  ...
  app.post('/api/user-pricing', isAuthenticated, async (req: any, res) => {
    try {
      const userId = req.user.claims.sub;
      const pricingData = { ...req.body, userId };
  ...
  app.put('/api/user-pricing/:id', isAuthenticated, async (req: any, res) => {
    try {
      ...
      const updatedPricing = await storage.updateUserPricing(id, req.body);
  ...
  app.put('/api/equipment-types/:id', isAuthenticated, async (req: any, res) => {
    try {
      ...
      // For now, we'll simulate updating equipment types
      // In a real implementation, you'd add updateEquipmentType to storage
      res.json({ 
        id, 
        name, 
        description, 
  ...
  app.delete('/api/equipment-types/:id', isAuthenticated, async (req: any, res) => {
    try {
      ...
      // For now, we'll simulate deleting equipment types
      // In a real implementation, you'd add deleteEquipmentType to storage
